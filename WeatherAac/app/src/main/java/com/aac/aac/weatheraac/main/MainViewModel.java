...
public class MainViewModel extends ViewModel {
    ...
    private MutableLiveData<DataWrapper<Weather>> weatherResponseMutableLiveData = new MutableLiveData<>();

    private WeatherRepository weatherRepository;

    MainViewModel(ApiService apiService, LocalService localService) {
...
//                });
    ...
    MutableLiveData<DataWrapper<Weather>> getWeatherResponse(int id) {
        loadWeatherData(id);
